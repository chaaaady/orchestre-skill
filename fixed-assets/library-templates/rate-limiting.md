...
const inMemoryCache = new Map()  // Dev only — pas de persistance entre instances
...
export const apiRatelimit = process.env.UPSTASH_REDIS_REST_URL
  ...
  : new Ratelimit({ redis: inMemoryCache, limiter: Ratelimit.slidingWindow(100, "10 s") })
  // ephemeralCache pour dev
```
