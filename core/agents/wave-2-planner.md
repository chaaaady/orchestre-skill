...
- `Read` — read orchestre.intent.json, wave-0-brief.json, knowledge files
...
```json
{
  ...
  "required_knowledge": [
    ...
    "stacks/nextjs-supabase/knowledge/frontend-patterns.md",
    "stacks/nextjs-supabase/knowledge/supabase-patterns.md"
  ],
  "depends_on": ["T01"],
  "parallel_group": 1,
...
| C5 | Missing knowledge | All required_knowledge refs exist in knowledge files | WARNING |
