...
|------|---------------|--------|
| stripe-billing | Patterns Stripe (checkout, webhooks, billing portal) | stacks/nextjs-supabase/knowledge/stripe-billing.md |
| supabase-patterns | Patterns Supabase (clients, cache, relationships) | stacks/nextjs-supabase/knowledge/supabase-patterns.md |
| auth-hardening | Auth SSR, PKCE, middleware, getUser() | stacks/nextjs-supabase/knowledge/auth-hardening.md |
| error-handling | AppError, Result<T>, error boundaries | core/knowledge/error-handling.md |
| rls-patterns | 10 patterns RLS réutilisables | stacks/nextjs-supabase/knowledge/rls-patterns.md |
| frontend-patterns | Server/Client Components, Suspense | stacks/nextjs-supabase/knowledge/frontend-patterns.md |
| design-quality | 10 anti-patterns, checklist 10 points | core/knowledge/design-quality.md |
